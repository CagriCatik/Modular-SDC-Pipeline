...
def normalize_env_name(env_name: str) -> str:
    # Map deprecated CarRacing-v3 to the current v3
    if env_name.strip().lower() == "CarRacing-v3":
        logging.info("Environment CarRacing-v3 is deprecated. Switching to CarRacing-v3.")
        return "CarRacing-v3"
    return env_name
